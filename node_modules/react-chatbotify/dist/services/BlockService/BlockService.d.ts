 ...
 */
export declare const preProcessBlock: (flow: Flow, path: string, params: Params, setTextAreaDisabled: (inputDisabled: boolean) => void, setPaths: Dispatch<SetStateAction<string[]>>, setTimeoutId: (timeoutId: ReturnType<typeof setTimeout>) => void, handleActionInput: (path: string, userInput: string, sendUserInput: boolean) => Promise<void>) => Promise<void>;
/**
 ...
 * @param setPaths updates the paths taken by the user
 */
export declare const postProcessBlock: (flow: Flow, path: string, params: Params, setPaths: Dispatch<SetStateAction<string[]>>) => Promise<boolean>;
