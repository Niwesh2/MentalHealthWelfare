 ...
 */
declare const saveChatHistory: (messages: Message[], chatHistory: string) => Promise<void>;
/**
 ...
 */
declare const loadChatHistory: (botOptions: Options, chatHistory: string, setMessages: Dispatch<SetStateAction<Message[]>>, setIsLoadingChatHistory: Dispatch<SetStateAction<boolean>>, setTextAreaDisabled: Dispatch<SetStateAction<boolean>>) => void;
